...
<article class="page-container">
	<form class="form form-horizontal" action="updateAdmin.action" name="userForm">
	<input type="hidden" name="user_id" value="${admin.user_id }">
	
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>用户名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${admin.user_name }" placeholder="" id="user_name" name="user_name">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${admin.user_pwd }" placeholder="" id="user_pwd" name="user_pwd">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${admin.user_real_name }" placeholder="" id="user_real_name" name="user_real_name">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="user_sex" class="select" value="${admin.user_sex}" ><!--   -->
					<!-- <option value="0">保密</option>
					<option value="1">男</option>
					<option value="2">女</option> -->
							<option ${admin.user_sex eq '0' ? 'selected="selected"' : ''} value="0">保密</option>
							<option ${admin.user_sex eq '1' ? 'selected="selected"' : ''} value="1">男</option>
							<option ${admin.user_sex eq '2' ? 'selected="selected"' : ''} value="2">女</option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${admin.user_birthday }" placeholder="" id="user_birthday" name="user_birthday">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${admin.user_mobile }" placeholder="" id="user_mobile" name="user_mobile">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${admin.user_level }" placeholder="" id="user_level" name="user_level">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${admin.user_info }" placeholder="" id="user_info" name="user_info">
			</div>
		</div>
