...
<article class="page-container">
	<form class="form form-horizontal" action="updateManager.action" name="managerForm">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${manager.manager_name }" placeholder="" id="manager_name" name="manager_name">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${manager.manager_pwd }" placeholder="" id="manager_pwd" name="manager_pwd">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${manager.manager_real_name }" placeholder="" id="manager_real_name" name="manager_real_name">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${manager.manager_tele }" placeholder="" id="manager_tele" name="manager_tele">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${manager.manager_permission }" placeholder="" id="manager_permission" name="manager_permission">
			</div>
		</div>
