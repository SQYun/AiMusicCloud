...
<article class="page-container">
	<form class="form form-horizontal" action="updateImage.action" name="imageForm">
			<input type="hidden" name="song_id" value="${image.image_id}">
	
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>具体对象：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${image.img_type }" placeholder="" id="img_type" name="img_type">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${image.img_use }" placeholder="" id="img_use" name="img_use">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${image.img_value }" placeholder="" id="img_value" name="img_value">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${image.img_adduser }" placeholder="" id="img_adduser" name="img_adduser">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${image.img_addtime }" placeholder="" id="img_addtime" name="img_addtime">
			</div>
		</div>
